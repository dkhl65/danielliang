  ...
  return (
    <>
      ...
      <p>
        ...
        controlled by the ATTiny84, which is a smaller microcontroller chip that
        can be programmed through the Arduino Uno. I also added a volume knob
        for the piezo. The Uno file is{" "}
        <a
