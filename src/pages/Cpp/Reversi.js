  ...
  return (
    <>
      ...
      <p>
        ...
        program is text-based and displays on the console with CodeLite IDE. It
        plays a Reversi game between the user and a computer AI algorithm. It
        also played my AI vs. the professor's AI, which is part of the
        assignment. The board's size is set at the beginning of the game. The
        user enters the coordinates to place their piece. B represents black, W
        represents white and U represents an empty square. The project file is{" "}
        <a
